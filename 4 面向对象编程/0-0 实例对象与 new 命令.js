 ...
 * @LastEditTime: 2020-04-21 17:42:00
...
try {
  ...
  console.log(error.message) // 请使用new命令调用
}

new f1()

// 4.Object.create() 创建实例对象 => 构造函数作为模板，可以生成实例对象。但是，有时拿不到构造函数，只能拿到一个现有的对象。我们希望以这个现有的对象作为模板，生成新的实例对象，这时就可以使用Object.create()方法
...
console.log(person2.full()) // 法外狂徒张三